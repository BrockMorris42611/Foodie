...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val url = "http://cis-linux2.temple.edu:8080/SP22_4515_tuj42611/getRestaurantId.jsp?restaurantId=0"
        ...
        val jsonObjectRequest = JsonObjectRequest(
            ...
            Response.ErrorListener {
                System.out.println(">>>>>>>>>>>>>>>>>>>>DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD" + it.toString())
            })
